...
public class login
{
    ...
    login() throws Exception
    {
		...
		ImageIcon img =new ImageIcon("/home/gr1dl0ck/Documents/JavaProject/src/UI/mainpage.jpg");//background
//      							------------------------------------------------------------------------------------
...
//                           		 So to get a the proper layout of the image,do go to the src folder of this project and copy the path of homepage.jpg file.
		...
		img =new ImageIcon("/home/gr1dl0ck/Documents/JavaProject/src/UI/homepage.jpg");//background
		//                           ------------------------------------------------------------------------------------
		//                           This is the path of the image file stored in your system.this path may vary from system to system.
		//                           So to get a the proper layout of the image,do go to the src folder of this project and copy the path of homepage.jpg file.
		...
		ImageIcon img2 =new ImageIcon("/home/gr1dl0ck/Documents/JavaProject/src/UI/homepage.jpg");//background
		//                           ------------------------------------------------------------------------------------
		//                           This is the path of the image file stored in your system.this path may vary from system to system.
		//                           So to get a the proper layout of the image,do go to the src folder of this project and copy the path of homepage.jpg file.
